...
ttk.Button(janela, text="Caminhões", width=25, command=abrir_tela).pack(pady=5)
...
ttk.Button(janela, text="Funcionarios", width=25, command=abrir_tela_funcionarios).pack(pady=5)
ttk.Button(janela, text="Fornecedores", width=25, command=abrir_tela_fornecedores).pack(pady=5)
ttk.Button(janela, text="Registro Saida Caminhões", width=25, command=abrir_tela_saida_caminhao).pack(pady=5)
